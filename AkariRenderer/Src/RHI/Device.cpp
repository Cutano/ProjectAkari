...
std::shared_ptr<Akari::IndexBuffer>
    Akari::Device::CreateIndexBuffer( Microsoft::WRL::ComPtr<ID3D12Resource> resource, size_t numIndices,
                                        DXGI_FORMAT indexFormat )
{
...
std::shared_ptr<Akari::VertexBuffer>
    Akari::Device::CreateVertexBuffer( Microsoft::WRL::ComPtr<ID3D12Resource> resource, size_t numVertices,
                                         size_t vertexStride )
{
...
std::shared_ptr<Akari::RootSignature>
    Akari::Device::CreateRootSignature( const D3D12_ROOT_SIGNATURE_DESC1& rootSignatureDesc )
{
