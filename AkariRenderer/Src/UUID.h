...
namespace std {
    ...
    template <>
    struct hash<Akari::UUID>
    {
        std::size_t operator()(const Akari::UUID& uuid) const noexcept
        {
    ...
    template <>
    struct hash<Akari::UUID32>
    {
        std::size_t operator()(const Akari::UUID32& uuid) const noexcept
        {
